...
public class SpotifyController {
    ...
    public static List<mappers.Track.Track> searchTrack(@PathVariable String trackName) {
    ...
    public static List<mappers.Track.Track> getRecommendations(@PathVariable String seedOne) {
